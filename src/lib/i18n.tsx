...
const translations = {
  es: {
    ...
    'chat.disclaimer': 'Demo · próximamente con agente IA',
    'chat.open': 'Abrir chat',
    'chat.close': 'Cerrar chat',
    'chat.placeholder': 'Pregúntame algo...',
    'chat.send': 'Enviar',
    'chat.welcome': '¡Hola! 👋 Soy tu guía por el portafolio de Luisana. Puedo contarte sobre los proyectos, el stack tecnológico o ayudarte a encontrar algo específico. ¿En qué te ayudo?',
    'chat.suggestion1': '¿Qué proyectos hay?',
    'chat.suggestion2': '¿Qué tecnologías usa?',
    'chat.suggestion3': 'Cuéntame de Lakehouse',
  ...
  en: {
    ...
    'chat.disclaimer': 'Demo · soon with AI agent',
    'chat.open': 'Open chat',
    'chat.close': 'Close chat',
    'chat.placeholder': 'Ask me anything...',
    'chat.send': 'Send',
    'chat.welcome': 'Hi! 👋 I\'m your guide to Luisana\'s portfolio. I can tell you about the projects, the tech stack, or help you find something specific. How can I help?',
    'chat.suggestion1': 'What projects are there?',
    'chat.suggestion2': 'What tech does she use?',
