...
const translations = {
  es: {
    ...
    'detail.statusPublished': 'Publicado',
    ...
    'cv.footerNote': 'Este CV se mantiene automáticamente al ritmo del portafolio.',
    'header.blog': 'Blog',
    'blog.title': 'Blog',
    'blog.subtitle': 'Notas técnicas sobre los proyectos que construyo: decisiones, particularidades y aprendizajes.',
    'blog.empty': 'Todavía no hay posts. Vuelve pronto.',
    'blog.backToIndex': 'Volver al blog',
    'blog.notFound': 'No encuentro ese post.',
    'blog.viewRelatedProject': 'Ver el proyecto relacionado',
  ...
  en: {
    ...
    'cv.footerNote': 'This CV is auto-maintained alongside the portfolio.',
    'header.blog': 'Blog',
    'blog.title': 'Blog',
    'blog.subtitle': 'Technical notes on the projects I build: decisions, quirks and lessons.',
    'blog.empty': 'No posts yet. Come back soon.',
    'blog.backToIndex': 'Back to blog',
    'blog.notFound': 'Post not found.',
    'blog.viewRelatedProject': 'See the related project',
